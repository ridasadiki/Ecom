            ...
            <div class="p-6">
                ...
                <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500">Write a detailed description of the product. This will be used to generate the product image if no image is uploaded.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-lg">
                            <div class="space-y-1 text-center">
                                ...
                                <p class="text-xs text-gray-500 mt-2">Leave empty to auto-generate image using AI based on the product description</p>
                            </div>
                        </div>
                    </div>
